  ...
  <>
    ...
    <Box bg="black" color="white">
      <Container maxW="container.xl">
        {/* Header */}
        <Flex align="center" as="header" ml={[0, 14]}>
          <Image alt="Logo Francisco Cobas" src={FCLogo} w={[20, 28]} />
          <ContactLinks />
        </Flex>

        {/* Intro + Photo + Social Netwowrk (Desktop) */}
        <Grid
          gridTemplateAreas={[
            "'title title' 'fotoPerfil fotoPerfil' 'textPresentation textPresentation'",
            "'title fotoPerfil' 'textPresentation fotoPerfil' 'fotoPerfil fotoPerfil'",
          ]}
